// Format specific code for expandable_overlay_sticky
// float right version
this.Render = function () {
    ...
    closeButton1.style.left = '-5px'
    closeButton1.style.bottom = '-5px'
