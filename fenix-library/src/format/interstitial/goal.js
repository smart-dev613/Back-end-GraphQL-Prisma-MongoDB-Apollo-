...
this.Render = function () {
  ...
  window.frameElement.parentElement.parentElement.parentElement.style.zIndex = 5
  window.frameElement.parentElement.parentElement.parentElement.style.position = 'fixed'
