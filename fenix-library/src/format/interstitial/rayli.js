...
this.Render = function () {
  ...
  closeButton.style.background = 'url("https://cdn.inspired-mobile.cn/fancy_close_white.png") no-repeat center center'
  ...
  var adChars = document.createElement('div')
  adChars.innerHTML = '广告'
  adChars.style.position = 'absolute'
  adChars.style.bottom = '0px'
  adChars.style.left = '0px'
  adChars.style.color = '#ffffff'
  adChars.style.backgroundColor = '#5a5a5a'
  adChars.style.fontSize = '12px'
  adChars.style.padding = '1px 5px'
  
  fenix.Config.Container.appendChild(adChars)
