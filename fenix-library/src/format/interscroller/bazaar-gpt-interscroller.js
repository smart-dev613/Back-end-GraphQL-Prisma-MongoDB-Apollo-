...
this.Render = function () {
    ...
    window.parent.document.getElementById('innity-in-post').parentElement.appendChild(div)
  }
  this.Fix = function () {
    if (window.frameElement) {
  ...
  this.Render()
  this.Fix()// Format specific code for interscroller
  // 'fenix' is available
  this.Render = function () {
    // Container
    var iframeContainer = document.createElement('div');
    ...
    div.appendChild(iframeContainer);
    div.appendChild(footerContainer);
    window.parent.document.getElementById('listicle-ad-breaker-5').parentElement.appendChild(div)
  }
  this.Fix = function () {
    if (window.frameElement) {
      window.frameElement.parentNode.style.zIndex = '-1'
