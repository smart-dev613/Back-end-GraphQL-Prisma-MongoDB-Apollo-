...
this.AppendBanners = function () {
  if (window.frameElement) {
    ...
    advertisementDiv.style.padding = '18px'
    ...
    scrollToContentDiv.innerText = 'scroll to continue'
    scrollToContentDiv.style.textTransform = 'uppercase'
    scrollToContentDiv.style.zIndex = '4'
    scrollToContentDiv.style.fontSize = '13'
    scrollToContentDiv.style.position = 'absolute'
    scrollToContentDiv.style.width = '100%'
    scrollToContentDiv.style.bottom = '1px'
    scrollToContentDiv.style.paddingRight = '15%'

    window.frameElement.parentNode.insertBefore(advertisementDiv, window.frameElement.parentNode.firstChild)
    window.frameElement.parentNode.appendChild(scrollToContentDiv)
  }
}
