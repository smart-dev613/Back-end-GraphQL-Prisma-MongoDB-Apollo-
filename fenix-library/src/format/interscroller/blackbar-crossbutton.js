...
this.Render = function () {
    ...
    dropdownIconLeft.style.setProperty('height', '3px');
    ...
    dropdownIconLeft.style.setProperty('left', '5px');
    ...
    dropdownIconRight.style.setProperty('height', '3px');
    ...
    dropdownIconRight.style.setProperty('left', '-5px');
    ...
    dropdownContainer.addEventListener('click', function () {
      ...
      if (dropdownContainer.classList.contains('close')) {
        dropdownIconLeft.style.setProperty('display', 'none');
      }
    });
  }
  this.Fix = function () {
