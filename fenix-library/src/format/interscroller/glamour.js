...
this.Render = function () {
  ...
  if (window.frameElement) {
    ...
    window.frameElement.parentNode.style.width = 'calc(100vw - 40px)'
    ...
    window.frameElement.style.width = 'calc(100vw - 40px)'
    window.frameElement.style.height = '100vh'
    window.frameElement.style.border = '0px'
    window.frameElement.style.position = 'fixed'
    window.frameElement.style.top = '60px'
    window.frameElement.style.left = '20px'
